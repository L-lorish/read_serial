...
set(MSG_I_FLAGS "-Imy_msgs:/home/linyuan/experiment/read_serial/src/my_msgs/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/linyuan/experiment/read_serial/src/my_msgs/msg/uwb_type.msg" NAME_WE)
add_custom_target(_my_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "my_msgs" "/home/linyuan/experiment/read_serial/src/my_msgs/msg/uwb_type.msg" ""
)
...
_generate_msg_cpp(my_msgs
  "/home/linyuan/experiment/read_serial/src/my_msgs/msg/uwb_type.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/my_msgs)
  install(CODE "execute_process(COMMAND \"/home/linyuan/anaconda3/envs/ros_env/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/my_msgs\")")
  # install generated code
  install(
